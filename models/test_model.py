...
device = torch.device("cuda" if torch.cuda.is_available() else "cpu") # chin added 20220202
class TestModel(BaseModel):
    ...
    def forward(self):
        #self.fake_B = self.netG(self.real_A) # Chin commented on 2022.02.02
        self.fake_B = self.netG(self.real_A.to(device)) # Chin added on 2022.02.02
