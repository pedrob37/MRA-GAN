...
class RandomCrop(object):
    ...
    def __call__(self, sample):
        ...
        roiFilter = sitk.RegionOfInterestImageFilter()
        # roiFilter.SetSize([size_new[0], size_new[1], size_new[2]]) # chin commented 2022.01.28
        roiFilter.SetSize([int(size_new[0]), int(size_new[1]), int(size_new[2])]) # chin added 2022.01.28
