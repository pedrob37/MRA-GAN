...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lambda_idt', type=float, default=0.1, help='IDT lambda')
        ...
        parser.add_argument('--use_csv', type=self.str2bool, nargs='?', const=True, default=True, help='Whether to split data based on csv')
        ...
        parser.add_argument('--weighted_sampling', type=str, default="None", help='Whether to weight by MRA or not')
        ...
        parser.add_argument('--identity_loss', type=self.str2bool, nargs='?', const=True, default=False, help='use identity losses or not')
