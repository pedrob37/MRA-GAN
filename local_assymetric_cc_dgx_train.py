...
if __name__ == '__main__':
    ...
    for fold in range(10):
        ...
        #               0.999)  # Consider 0.5 for beta1! https://machinelearningmastery.com/how-to-train-stable-generative-adversarial-networks/
        # Generators
        G_A = nnUNet(1, 1, dropout_level=0.0)
        G_B = nnUNet(1, 1, dropout_level=0.0, z_concat_flag=True, z_output=128)
        ...
        D_z = NoisyMultiscaleDiscriminator3D(128, opt.ndf,
                                             3,
                                             nn.InstanceNorm3d, False, 1, False)
